...
class DOCXPRESSO_SDK
{
    ...
    {    
        var url = this._options['docxpressoInstallation'] + '/RESTservices/predefined/modify_signature_providers/' + provider;
...
module.exports.DOCXPRESSO_SDK = DOCXPRESSO_SDK;